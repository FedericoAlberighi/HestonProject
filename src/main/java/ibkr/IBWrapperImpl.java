...
public class IBWrapperImpl implements EWrapper {
    ...
    public void error(int id, int errorCode, String errorMsg, String advancedOrderRejectJson) {
        // IBKR manda un sacco di messaggi informativi sotto forma di "errori" (es. connessione alla market data farm)
        System.out.println("Messaggio TWS [" + errorCode + "]: " + errorMsg);
    }
